...
public class PuzzleGUI extends JFrame {
    ...
    private String[] puzzleNames = {"Level 1",
        "Level 2"};
    private String[] puzzleKeyNames = {"puzzledatatest",
        "a01-level01"};
    private JButton levelButtons[] = new JButton[puzzleNames.length];

    // declare amd initialize jackson json utility
    ...
    public PuzzleGUI() {
        ...
        for (int i = 0; i < levelButtons.length; i++) {
            ...
            levelButtons[i].addActionListener(event -> showPuzzle(puzzleKeyNames[0]));
        }
    ...
    private void showPuzzle(String puzzleName) {
        ...
        try {
            puzzle = mapper.readValue(puzzle.readData(puzzleName), Puzzle.class);
